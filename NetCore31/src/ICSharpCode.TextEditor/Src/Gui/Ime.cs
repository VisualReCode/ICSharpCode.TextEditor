...
namespace ICSharpCode.TextEditor
{
    ...
    internal class Ime
    {
        ...
        public Ime(IntPtr hWnd, Font font)
        {
            ...
            // The above code doesn't work in .NET Core 3.1 and neither does IME so we'll just disable it.
            disableIME = true;
        ...
        private static extern IntPtr SendMessage(
            IntPtr hWnd, int msg, IntPtr wParam, [In] [MarshalAs(UnmanagedType.LPStruct)]
            LOGFONT lParam);
